...
<a href="{{ route('employee.details.edit', $employee->id) }}" class="btn btn-primary pull-right"><i class="fa fa-fw fa-edit"></i> {{ trans('common.edit') }}</a>  
...
<div class="col-sm-6">
	<dl class="row">
		<dd class="col-sm-12">
			@if($employee->picture)
				<img class="img-lazy thumbnail img-responsive" src="{{ $employee->picture->url('small') }}">
			@else
