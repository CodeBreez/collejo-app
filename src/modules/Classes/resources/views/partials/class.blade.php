<tr id="{{ $class->id }}" class="class-block">
	...
	<td class="tools-column">
		<a href="{{ route('grade.class.edit', [$grade->id, $class->id]) }}" data-toggle="ajax-modal" data-modal-backdrop="static" data-modal-keyboard="false" class="btn btn-xs btn-default"><i class="fa fa-edit"></i>
		</a>
