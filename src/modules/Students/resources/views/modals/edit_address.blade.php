...
<div class="modal-content">
    <form method="POST" id="edit-contact" class="form-horizontal" action="{{ $address ? route('student.address.edit', ['student' => $student->id, 'address' => $address]) : route('student.address.new', $student->id) }}?target=addreses">
