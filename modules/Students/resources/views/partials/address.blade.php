    ...
    <div class="panel panel-default">
        ...
        <div class="panel-footer">
            ...
            <div class="tools-footer">
                <a data-toggle="ajax-modal" data-modal-backdrop="static" data-modal-keyboard="false" href="{{ route('students.edit.addresses.edit', ['id' => $student->id, 'cid' => $address->id]) }}" class="btn btn-xs btn-default pull-left"><i class="fa fa-edit"></i> Edit</a>
                <a data-success-callback="afterDeleteAddress" data-toggle="ajax-link" data-confirm="Delete this?" href="{{ route('students.edit.addresses.delete', ['id' => $student->id, 'cid' => $address->id]) }}" class="btn btn-xs btn-danger pull-left"><i class="fa fa-trash"></i> Delete</a>
            </div>
        </div>
    </div>
</div>