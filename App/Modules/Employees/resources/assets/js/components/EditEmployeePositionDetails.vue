    ...
    <b-form @submit.prevent="onSubmit" novalidate>
        ...
        <div class="col-md-6">
            ...
            <c-form-input type="text"
                          v-model="form.name"
                          name="name"
                          :label="trans('employees::employee_position.name')"
            ...
            <c-form-input type="select"
                          ...
                          :label="trans('employees::employee_position.employee_category')"
                          :validator="$v"></c-form-input>
...
<script>
    ...
    export default {
        ...
        data(){
            ...
            return {
                action: this.entity ? this.route('employee_position.details.edit', this.entity.id) : this.route('employee_position.new')
            }
        },
